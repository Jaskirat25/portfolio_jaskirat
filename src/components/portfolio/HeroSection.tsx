...
import { ContactButton, ResumeButton } from "./ContactButton";
      ...
      <div className="flex-1 flex flex-col justify-between relative">
        ...
        >
          <FadeIn delay={0.6} y={30}>
            <img src={PORTRAIT} alt="Jaskirat portrait" className="w-full h-auto" />
          </FadeIn>
        </Magnet>
        ...
        <div className="flex justify-between items-end pb-7 sm:pb-8 md:pb-10 px-6 md:px-10 relative z-20">
          <FadeIn delay={0.35} y={20}>
            ...
            >
              a full-stack &amp; ai developer driven by crafting striking and unforgettable projects
            </p>
          </FadeIn>
          <FadeIn delay={0.5} y={20} className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <ContactButton />
            <ResumeButton variant="dark" />
          </FadeIn>
        </div>
      </div>
    </section>
