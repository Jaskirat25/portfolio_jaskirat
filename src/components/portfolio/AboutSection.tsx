  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-10 sm:gap-14 md:gap-16 relative z-10">
        ...
        <AnimatedText
          text="I'm a Computer Science student building full-stack web apps and AI systems. I focus on real-time platforms, RAG pipelines, and ML-driven products that solve real problems. Let's build something incredible together!"
          className="font-medium text-center leading-relaxed max-w-[560px]"
          style={{ color: "#D7E2EA", fontSize: "clamp(1rem, 2vw, 1.35rem)" }}
        />
      </div>

      <div className="mt-16 sm:mt-20 md:mt-24 relative z-10 flex flex-col sm:flex-row items-center gap-4">
        <FadeIn delay={0} y={20}>
          <ContactButton />
        </FadeIn>
